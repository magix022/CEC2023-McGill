...
import data from './algo2output.json';

@Component({
  selector: 'app-form',
  templateUrl: './algo2.component.html',
  styleUrls: ['./algo2.component.scss']
})
export class Algo2Component {
  ...
  graph1 = {
    ...
    layout: {
      title: {
        text:'Algorithm 2: Money Per Country',
        font: {
  ...
  graph2 = {
    ...
    layout: {
      title: {
        text:'Algorithm 2: Resources Per Country By Sector',
        font: {
          family: 'Courier New, monospace',
          size: 26
        },
  ...
  graph3 = {
    ...
    layout: {
      title: {
        text:'Algorithm 2: Country By Resource',
        font: {
          family: 'Courier New, monospace',
          size: 26
        },
