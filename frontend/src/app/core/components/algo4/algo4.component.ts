...
import data from './algo4output.json';
...
export class Algo4Component {
  ...
  graph1 = {
    ...
    layout: {
      title: {
        text:'Algorithm 4: Money Per Country',
        font: {
  ...
  graph2 = {
    ...
    layout: {
      title: {
        text:'Algorithm 4: Resources Per Country By Sector',
        font: {
          family: 'Courier New, monospace',
          size: 26
        },
  ...
  graph3 = {
    ...
    layout: {
      title: {
        text:'Algorithm 4: Country By Resource',
        font: {
          family: 'Courier New, monospace',
          size: 26
        },
