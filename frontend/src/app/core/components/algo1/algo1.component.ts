...
import data from './algo1output.json';

@Component({
  selector: 'app-form',
  templateUrl: './algo1.component.html',
  styleUrls: ['./algo1.component.scss']
})
export class Algo1Component {
  ...
  graph1 = {
    ...
    layout: {
      title: {
        text:'Algorithm 1: Money Per Country',
        font: {
  ...
  graph2 = {
    ...
    layout: {
      title: {
        text:'Algorithm 1: Resources Per Country By Sector',
        font: {
          family: 'Courier New, monospace',
          size: 26
        },
  ...
  graph3 = {
    ...
    layout: {
      title: {
        text:'Algorithm 1: Country By Resource',
        font: {
          family: 'Courier New, monospace',
          size: 26
        },
